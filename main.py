...
def get_func_and_params(args):
    if args.get:
        return notion.get_block_children, args.get
    if args.get_page:
        return notion.get_page, args.get_page
    if args.get_db:
        return notion.get_db, args.get_db
    if args.get_full:
        return notion.deep_copy_page, args.get_full
    if args.get_block:
        return notion.get_block, args.get_block
    if args.query_db:
        return notion.query_db, args.query_db
...
if __name__ == "__main__":
    ...
    if args.get_spell:
        spells = [
            scraper.scrape_spell("/spell:" + spell).__dict__
            for spell in args.get_spell.split(" ")
        ]
    ...
    if args.fill_template:
        fill_character_sheet_template(args.fill_template, args.name)
    if (
        args.get
        or args.get_page
        or args.get_full
